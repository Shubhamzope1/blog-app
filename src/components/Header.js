...
class Header extends React.Component {
  ...
  <Container>
  <Navbar.Brand ><NavLink className="navigaters" to="/contact">Be Motivated</NavLink></Navbar.Brand>
  <Navbar.Toggle aria-controls="responsive-navbar-nav" />
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="me-auto">
      <Nav.Link href="/Digital"><NavLink className="navigaters" to="/Digital">Digital</NavLink></Nav.Link>
      <Nav.Link href="/profs"><NavLink className="navigaters" to="/professional">professional</NavLink></Nav.Link>
